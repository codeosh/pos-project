    ...
    <form id="addProductForm">
        ...
        <div class="grid grid-cols-2 gap-2 mb-3">
            <div class="flex gap-1">
                ...
                <x-bladewind.input label="P-Special Code" name="pscode" id="pscode" readonly="true" />
            </div>
            <div class="block">
                <x-bladewind.input label="Product Brand|Name or Description| Metrics(gram,kls,etc.)|Type" name="consignee" id="consignee" autocomplete="off" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-6 gap-2 mb-3">
            <!-- Drop Reorder Level -->
            <select name="dropLevel" id="dropLevel" class="dropdown w-full">
            ...
            <select name="dropWarranty" id="dropWarranty" class="dropdown w-full">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="p-2 border rounded-lg">
            ...
            <div class="flex gap-2">
                <x-bladewind.input name="markup_value" id="markup_value" placeholder="Enter markup" />
                <select name="markup_type" id="markup_type" class="dropdown">
