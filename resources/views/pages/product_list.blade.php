            ...
            <ul class="py-1">
                ...
                <li>
                    <a href="#" class="flex items-center gap-2 px-4 py-2 text-gray-700 text-sm hover:bg-gray-100">
                        <!-- S/N Serial Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 9.75h15m-12 0V16.5m0-6.75L3 12m3-2.25l3 2.25M15 12h3m-3-2.25l-3 2.25m3-2.25l-3 2.25"></path>
                        </svg>
                        S/N Serial
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center gap-2 px-4 py-2 text-gray-700 text-sm hover:bg-gray-100">
                        <!-- Printer Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 9V3h12v6M6 15H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2m-10 0h10v6H6v-6z"></path>
                        </svg>
                        Print & Export
                    </a>                    
                </li>
...
<script src="{{asset('js/page/product-list.js')}}">
</script>
@endsection